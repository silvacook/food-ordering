  ...
  return (
    <div className="bg-gradient-to-b from-amber-50 to-white min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        {/* Values section */}
        <div className="mb-16">
          <h2 className="text-3xl font-semibold text-amber-800 mb-8 text-center">Our Values</h2>
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-bold text-amber-700 mb-2">Quality</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-bold text-amber-700 mb-2">Accessibility</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-bold text-amber-700 mb-2">Sustainability</h3>
        ...
        {/* Team section */}
        <div className="mb-16">
          <h2 className="text-3xl font-semibold text-amber-800 mb-8 text-center">Meet Our Team</h2>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-amber-700">Libertad Macias</h3>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-amber-700">Robert Silva</h3>
                <p className="text-gray-500 mb-4">Chief Software Engineer</p>
        ...
        {/* Timeline */}
        <div className="mb-16">
          <h2 className="text-3xl font-semibold text-amber-800 mb-8 text-center">Our Journey</h2>
          <div className="relative border-l-4 border-amber-500 ml-12 pl-8 py-4 space-y-16">
            {/* Timeline item 1 */}
            <div className="relative">
              <div className="absolute -left-14 top-0 w-10 h-10 bg-amber-600 rounded-full flex items-center justify-center">
            ...
            <div className="relative">
              ...
              <h3 className="text-xl font-bold text-amber-700 mb-2">2022: Expansion</h3>
            ...
            <div className="relative">
              ...
              <h3 className="text-xl font-bold text-amber-700 mb-2">2024: Today</h3>
