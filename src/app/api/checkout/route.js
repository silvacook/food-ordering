    ...
    try {
        ...
        for (const cartProduct of cartProducts) {
            ...
            stripeLineItems.push({
                ...
                price_data: {
                    currency: 'USD',
                    product_data: { // Changed 'product' to 'product_data'
        ...
        const stripeSession = await stripe.checkout.sessions.create({
            ...
            mode: "payment",
            customer_email: userEmail, // Changed from user.email to userEmail
            success_url: `${process.env.NEXTAUTH_URL}/orders/`+ orderDoc._id.toString() + "?clear-cart=1",
            cancel_url: `${process.env.NEXTAUTH_URL}/cart?canceled=1`, // Fixed typo in 'cancel_url'
